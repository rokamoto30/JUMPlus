...
public class UserService {
	...
	public static User create(String username, String password, String email) throws Exception {
		String endpoint = String.format("/user/create/%s/%s/%s", username, password, email);
		String response = Request.send(endpoint, "POST");
		return Request.parse(response, User.class);		
	}
	
	public static User create(String curUser, String username, String password, String email) throws Exception {
